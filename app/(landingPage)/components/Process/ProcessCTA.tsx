...
export const ProcessCTA = () => {
  ...
  return (
    <motion.div
      ...
      className="mt-10 pt-10 md:mt-24 md:pt-16 flex flex-col md:flex-row items-start md:items-center justify-between gap-8"
    ...
    >
      ...
      <button
        ...
        className="px-8 py-4 self-center md:self-auto transition-all duration-300 hover:bg-[#111110] hover:text-[#f1ede4] hover:border-[#111110] shrink-0 cursor-pointer"
        style={{
