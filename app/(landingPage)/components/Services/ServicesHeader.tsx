...
export const ServicesHeader = () => (
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10 md:mb-20">
    <div>
      ...
      >
        Lo que<br />
        <span style={{ fontStyle: 'italic', color: '#82866f' }}>hacemos</span>
      </motion.h2>
    </div>
    <motion.p
    ...
    >
      Ofrecemos un espectro completo de servicios arquitectónicos adaptados a cada proyecto, con atención personalizada y visión integral del proceso.
    </motion.p>
  </div>
);
